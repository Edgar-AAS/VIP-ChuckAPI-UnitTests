...
class JokeDescriptionPresenterTests: XCTestCase {
    ...
    func testPresentJokeShouldFormatJokeForDisplay() {
        ...
        // then
        XCTAssertEqual(Seeds.Responses.response1.joke, viewControllerSpy.viewModel?.joke,
                       "presentJoke() deve pedir ao view controller para exibir a mesma joke que recebe")
    }
}
